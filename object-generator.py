...
min_length = int(input("enter the minimum length of the object."))
max_length = int(input("enter the maximum length of the object"))
min_breadth = int(input("enter the minimum breadth of the object"))
...
print(f"I have generated {num_objects} number of objects in the map.txt file  in your working directory")
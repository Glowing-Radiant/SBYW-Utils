...
with open("map.txt", "w") as f:
    ...
    for i, x in enumerate(selected_tiles):
        ...
        zone_line = f"zone {i+1} {i+1} 0 10 {music_file_name.split('.')[0]}, pitch {pitch}, volume {volume}"
        # Write the line to the map file
        f.write(ambience_line + "\n")
        f.write(zone_line + "\n")


print(f"I have generated {num_music_files} music files and saved them into map.txt in your working directory.")
